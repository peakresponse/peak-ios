...
class PatientsCollectionViewCell: UICollectionViewCell {
    ...
    private func commonInit() {
        ...
        containerView.addSubview(patientView)
        NSLayoutConstraint.activate([
            patientView.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 4),
            patientView.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 6),
